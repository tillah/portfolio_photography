...
export const metadata: Metadata = {
  title: "Portfolio",
  description:
    "Browse the photography portfolio of Elara Voss — proposals, graduations, birthday celebrations, and studio portrait sessions across London.",
};
    ...
    <>
      ...
      <section className="pt-32 pb-12 md:pt-40 md:pb-16 max-w-7xl mx-auto px-6 md:px-10">
        <div className="max-w-xl">
          ...
          <h1 className="font-[var(--font-cormorant)] text-5xl md:text-6xl font-light text-[#1a1a1a] leading-tight mb-6">
            Portfolio
          </h1>
      ...
      <Suspense fallback={<div className="py-24 text-center font-[var(--font-jost)] text-sm text-[#9c9289]">Loading gallery...</div>}>
        <PortfolioGallery />
      </Suspense>
    </>
  );
